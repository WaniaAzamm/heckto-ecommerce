...
import Heading from '../components/mcomponents/Heading'
import ServiceCard from '../components/mcomponents/ServiceCard'  
    ...
    return (
        ...
        <div className='w-full px-5 md:px-10 lg:px-40 py-20 '>
            <div className='flex flex-col lg:flex-row justify-center items-center gap-5'>
                <div className='hidden lg:block border border-gray-300 w-[570px] h-[370px] rounded-md relative'>
                    <Image src={"/b2.png"} width={555} height={390} className='rounded-md absolute w-1/2 lg:w-full -top-1 -right-4' alt='about' />
                </div>
                {/* <Image src={"/b2.png"} width={555} height={390} className='rounded-md block lg:hidden' alt='about' /> */}
