...
const PRDesign1 = ({ image }: { image?: string }) => {
  return (
    <>
      <div className="w-full h-[360px] flex flex-col relative group transition-all duration-200 hover:shadow-sm shadow-gray-300">
        ...
        <div className="flex flex-col items-center gap-2 bg-white group-hover:bg-blue  py-2">
          <h1 className="text-pink group-hover:text-white font-lato text-lg font-semibold">
            Cantilever chair
          </h1>
          ...
          <p className="font-josefin-sans font-normal text-sm text-offBlue group-hover:text-white">
            Code - Y523201
          </p>
          <p className="font-lato font-normal text-sm text-offBlue group-hover:text-white">
            $42.00
          </p>
        </div>
      ...
      <div className="w-full h-[360px] flex flex-col relative group transition-all duration-200 hover:shadow-sm shadow-gray-300">
        {/* Image */}
        <div className="w-full h-2/3 bg-skyBlue flex justify-center items-center">
          <Image src={"/product2.png"} height={170} width={170} alt="product" />
        </div>
      ...
      <div className="w-full h-[360px] flex flex-col relative group transition-all duration-200 hover:shadow-sm shadow-gray-300">
        {/* Image */}
        <div className="w-full h-2/3 bg-skyBlue flex justify-center items-center">
          <Image src={"/product3.png"} height={170} width={170} alt="product" />
        </div>
      ...
      <div className="w-full h-[360px] flex flex-col relative group transition-all duration-200 hover:shadow-sm shadow-gray-300">
        {/* Image */}
        <div className="w-full h-2/3 bg-skyBlue flex justify-center items-center">
          <Image src={"/product4.png"} height={170} width={170} alt="product" />
        </div>
